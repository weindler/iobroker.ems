...
exports.simulateGreedyBatterySelfConsumption = void 0;
function round3(n) {
 ...
 */
function simulateGreedyBatterySelfConsumption(input) {
    ...
    const maxChargeKwhPerSlot = input.maxChargeW !== null && input.maxChargeW > 0
        ? (input.maxChargeW / 1000) * input.slotHours
        : Number.POSITIVE_INFINITY;
    const maxDischargeKwhPerSlot = input.maxDischargeW !== null && input.maxDischargeW > 0
...
exports.simulateGreedyBatterySelfConsumption = simulateGreedyBatterySelfConsumption;
