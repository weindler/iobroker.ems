import type { HouseCompareSummary, MobilityCompareSummary } from "./types";

/** Flache Objektbaum-States (Hybrid: JSON + Einzelwerte). */
export const STATISTICS_FLAT = {
	homeToday: {
...
export type FlatSetFn = (id: string, val: ioBroker.StateValue) => Promise<void>;

export type HomeFlatIds = typeof STATISTICS_FLAT.homeToday | typeof STATISTICS_FLAT.homePeriod;
export type MobilityFlatIds = typeof STATISTICS_FLAT.mobilityToday | typeof STATISTICS_FLAT.mobilityPeriod;

function n(v: number | null | undefined): number | null {
	return v === null || v === undefined || !Number.isFinite(v) ? null : v;
}

export async function publishHomeFlat(
	set: FlatSetFn,
	ids: HomeFlatIds,
	sum: HouseCompareSummary,
...
export async function publishMobilityFlat(
	set: FlatSetFn,
	ids: MobilityFlatIds,
	sum: MobilityCompareSummary,
	labelFallback: string,
): Promise<void> {
