...
async function ensureImmersionRuntimeStates(host) {
    ...
    const defs = [
        ...
        numState(types_1.IMMERSION_RUNTIME_STATES.minRuntimeRemainingSec, "Mindestlaufzeit Rest (s)", 0),
        numState(types_1.IMMERSION_RUNTIME_STATES.minPauseRemainingSec, "Mindestpause Rest (s)", 0),
        numState(types_1.IMMERSION_RUNTIME_STATES.configMinimumRuntimeSec, "Admin Mindestlaufzeit (s)"),
        numState(types_1.IMMERSION_RUNTIME_STATES.configMinimumPauseSec, "Admin Mindestpause (s)"),
