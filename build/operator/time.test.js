...
(0, node_test_1.describe)("operator time formatter cache", () => {
    ...
    (0, node_test_1.it)("preserves Europe/Berlin slot boundaries including DST offsets", () => {
        ...
        strict_1.default.equal((0, time_js_1.isoAtTimezoneLocal)("2026-07-15", 0, 0, "Europe/Berlin"), "2026-07-15T00:00:00.000Z");
        strict_1.default.equal((0, time_js_1.isoAtTimezoneLocal)("2026-01-15", 0, 0, "Europe/Berlin"), "2026-01-15T00:00:00.000Z");
        strict_1.default.equal((0, time_js_1.zonedFormatterCacheSizeForTest)(), 1);
    });
