...
export async function ensurePlannerCoordinatorStates(
	...
	const defs: StateDef[] = [
		...
		strState(PLANNER_COORDINATOR_STATE_IDS.lastErrorStage, "Coordinator Fehlerstufe"),
		strState(PLANNER_COORDINATOR_STATE_IDS.lastErrorDetail, "Coordinator Fehlerdetail"),
