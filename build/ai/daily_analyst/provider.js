...
exports.createOpenAiAnalystProvider = void 0;
...
function createOpenAiAnalystProvider(fetchImpl = fetch) {
    return {
        async analyze(context, opts) {
            ...
            try {
                ...
                const validated = (0, validate_response_1.validateAiAnalystResponse)(parsed, context.dateKey);
                if (!validated.ok) {
                    return emptyResult({
                        ok: false,
                ...
                return {
                    ...
                    reasonDe: validated.findings.length > 0
...
exports.createOpenAiAnalystProvider = createOpenAiAnalystProvider;
