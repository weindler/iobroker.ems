...
export const IMMERSION_RUNTIME_STATES = {
	...
	decisionSource: `${IMMERSION_RUNTIME_BASE}.decision_source`,
	dailyPlanStatus: `${IMMERSION_RUNTIME_BASE}.daily_plan_status`,
	dailyPlanRevision: `${IMMERSION_RUNTIME_BASE}.daily_plan_revision`,
	dailyPlanSlotStart: `${IMMERSION_RUNTIME_BASE}.daily_plan_slot_start`,
	dailyPlanSlotEnd: `${IMMERSION_RUNTIME_BASE}.daily_plan_slot_end`,
	allocatedPowerW: `${IMMERSION_RUNTIME_BASE}.allocated_power_w`,
	mandatoryAllocatedPowerW: `${IMMERSION_RUNTIME_BASE}.mandatory_allocated_power_w`,
