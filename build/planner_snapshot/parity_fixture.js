...
exports.createParityIoBrokerHost = exports.createParityFixtureSource = exports.parityFixtureForeign = exports.parityFixtureStates = exports.parityFixtureTibberTodayJson = exports.parityFixtureConfig = exports.stateVal = void 0;
...
exports.stateVal = stateVal;
function parityFixtureConfig() {
    return {
...
exports.parityFixtureConfig = parityFixtureConfig;
function parityFixtureTibberTodayJson() {
...
exports.parityFixtureTibberTodayJson = parityFixtureTibberTodayJson;
function parityFixtureStates() {
    return {
        ...
        [ensure_states_1.BAT.telemetry.socPct]: stateVal(62),
        [ensure_states_1.BAT.telemetry.capacityEffectiveKwh]: stateVal(10.2),
        [ensure_states_1.BAT.identity.capacityNetKwh]: stateVal(10),
        [ensure_states_1.BAT.identity.capacitySource]: stateVal("manual"),
        [ensure_states_1.BAT.limits.hardwareMinSocPct]: stateVal(10),
        [ensure_states_1.BAT.limits.hardwareMaxSocPct]: stateVal(100),
        [ensure_states_1.BAT.limits.effectiveMaxChargeW]: stateVal(5000),
        [ensure_states_1.BAT.capabilities.setChargePower]: stateVal(true),
        [ensure_states_1.BAT.capabilities.setDischargePower]: stateVal(true),
        [ensure_states_1.BAT.status.fault]: stateVal(false),
        [ensure_states_1.BAT.status.lockout]: stateVal(false),
        [ensure_states_1.BAT.telemetry.valid]: stateVal(true),
        [ensure_states_1.BAT.telemetry.stale]: stateVal(false),
        [ensure_states_1.BAT.status.telemetryReady]: stateVal(true),
        [ensure_states_1.BAT.runtime.ownershipActive]: stateVal(false),
        "planner.intent.battery.winter.active": stateVal(false),
        [ensure_evcc_states_1.WALLBOX_EVCC_STATES.connected]: stateVal(false),
        [ensure_evcc_states_1.WALLBOX_EVCC_STATES.charging]: stateVal(false),
        [ensure_evcc_states_1.WALLBOX_EVCC_STATES.batteryMode]: stateVal("normal"),
        [ensure_evcc_states_1.WALLBOX_EVCC_STATES.batteryDischargeControl]: stateVal(false),
        [types_1.IMMERSION_RUNTIME_STATES.bufferTemperatureC]: stateVal(44),
        [types_1.IMMERSION_RUNTIME_STATES.faultActive]: stateVal(false),
        [types_1.IMMERSION_RUNTIME_STATES.state]: stateVal("auto_ready"),
...
exports.parityFixtureStates = parityFixtureStates;
function parityFixtureForeign() {
    return {
...
exports.parityFixtureForeign = parityFixtureForeign;
function createParityFixtureSource(overrides = {}) {
    ...
    return {
        ...
        readJsonFile: async (p) => jsonFiles[p] ?? null,
        readConfig: async () => config,
        now: () => now,
    };
}
exports.createParityFixtureSource = createParityFixtureSource;
function createParityIoBrokerHost(overrides = {}) {
    ...
    return {
        ...
        getStateAsync: async (id) => {
            const st = states[id];
            return st ? { val: st.val, ts: st.ts ?? 0, lc: st.ts ?? 0, ack: true } : null;
        },
...
exports.createParityIoBrokerHost = createParityIoBrokerHost;
