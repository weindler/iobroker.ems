...
export const RECENT_DOUBLE_WEIGHT_DAYS = 90;
...
export const PLAUSIBLE_CT_MIN = -1_000;
export const PLAUSIBLE_CT_MAX = 1_000;

/** Plausible €/kWh. */
export const PLAUSIBLE_EUR_MIN = -10;
export const PLAUSIBLE_EUR_MAX = 10;
