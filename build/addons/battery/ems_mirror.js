...
exports.ensureBatteryEmsMirrorStates = exports.EMS_MIRROR_BATTERY_IDS = exports.EMS_MIRROR_BATTERY = void 0;
...
exports.EMS_MIRROR_BATTERY_IDS = Object.values(exports.EMS_MIRROR_BATTERY);
async function ensureBatteryEmsMirrorStates(adapter) {
    const defs = [
        ...
        {
            _id: exports.EMS_MIRROR_BATTERY.operatingModeTarget,
            common: {
        ...
        {
            _id: exports.EMS_MIRROR_BATTERY.chargePowerWRequest,
            common: {
        ...
        {
            _id: exports.EMS_MIRROR_BATTERY.modeRequestId,
            common: {
