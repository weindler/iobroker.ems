...
(0, node_test_1.describe)("passive battery energy availability", () => {
    (0, node_test_1.it)("wendet einen flüchtigen Hold nur auf den aktuellen Slot der SOC-Projektion an", () => {
        const input = (0, fixtures_js_1.golden001Input)();
        const slots = (0, fixtures_js_1.buildSlots)("2026-08-04T00:00:00.000Z", 1);
        input.time = {
            ...input.time,
        ...
        input.wallbox = null;
        input.otherFlex = [];
        const plan = (0, allocate_js_1.allocateUnifiedDayPlan)(input);
        strict_1.default.equal(plan.batteryTrajectory[0].socPct, 80);
        strict_1.default.ok((plan.batteryTrajectory[1].socPct ?? 80) < 80);
    });
