...
const SYSTEM_PROMPT_THINKING = [
	...
	"immersion: use thermalEstimatedRemainingHours + thermalEstimatedEmptyAtLocalDe for German prose",
	"(LocalDe is house timezone clock; ISO thermalEstimatedEmptyAt is UTC — never read UTC digits as local time).",
	"heat_today if buffer risk / empty soon; else defer_tomorrow if PV tomorrow much better.",
