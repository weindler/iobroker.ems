...
exports.REASON = {
    ...
    VEHICLE_GOAL_AT_RISK_DUE_TO_UNKNOWN_AVAILABILITY: "vehicle_goal_at_risk_due_to_unknown_availability",
    VEHICLE_IMPORT_WINDOW_AVAILABLE: "vehicle_import_window_available",
    VEHICLE_PV_WINDOW_AVAILABLE: "vehicle_pv_window_available",
    VEHICLE_TARGET_SOFT: "vehicle_target_soft",
    VEHICLE_EXTERNALLY_MANAGED: "vehicle_externally_managed",
    VEHICLE_TAKEOVER_CANDIDATE: "vehicle_takeover_candidate",
    VEHICLE_EXTERNAL_RESERVATION: "vehicle_external_reservation",
    VEHICLE_GRID_MUTEX_BATTERY: "vehicle_grid_mutex_battery",
