...
async function ensureEconomicsStates(host) {
    ...
    const defs = [
        ...
        numState(exports.ECONOMICS_FLAT.todayEmsVorteilEur, "EMS-Effekt heute (positiv = gespart)", "EUR"),
        ...
        numState(exports.ECONOMICS_FLAT.periodEmsVorteilEur, "EMS-Effekt Zeitraum (positiv = gespart)", "EUR"),
        ...
        numState(exports.ECONOMICS_FLAT.cumulativeEmsVorteilEur, "EMS-Effekt kumuliert (positiv = gespart)", "EUR"),
