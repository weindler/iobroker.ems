...
async function ensureStatisticsStateTree(host) {
    ...
    await (0, state_util_1.ensureStates)(host, [
        ...
        numState(exports.STATISTICS_STATES.homePeriodSavingsEur, "Haus Periode Ersparnis vs. Festtarif", "EUR"),
        ...
        numState(exports.STATISTICS_STATES.mobilityPeriodSavingsEur, "Mobilität Periode Ersparnis vs. Verbrenner", "EUR"),
        {
