...
export async function ensureImmersionRuntimeStates(host: StateHost): Promise<void> {
	...
	const defs: StateDef[] = [
		...
		numState(IMMERSION_RUNTIME_STATES.planningMinTempC, "Legacy Planungsuntergrenze °C"),
		...
		numState(IMMERSION_RUNTIME_STATES.forecastTargetTempC, "Forecast-Basisziel °C"),
