...
function aiTriggerDigestPayload(plan) {
    return JSON.stringify({
        ...
        flexibleAllocatedEnergyKwhBucket: bucket(plan.totals.flexibleAllocatedEnergyKwh, exports.AI_TRIGGER_ENERGY_BUCKET_KWH),
        flexibleUnallocatedEnergyKwhBucket: bucket(plan.totals.flexibleUnallocatedEnergyKwh, exports.AI_TRIGGER_ENERGY_BUCKET_KWH),
