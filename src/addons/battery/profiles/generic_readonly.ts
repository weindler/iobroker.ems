...
export const GENERIC_READONLY_PROFILE: BatteryProfile = {
	...
	catalog: {
		...
		setupHintDe: "Vorhandene ioBroker-Datenpunkte manuell zuordnen; aus Sicherheitsgründen nur Telemetrie.",
	},
	plannerCapabilities: {
		chargeDispatch: false,
		activeDischargeDispatch: false,
		passiveSelfConsumption: false,
		gridBalanceControl: false,
	},
	supportsRead: true,
