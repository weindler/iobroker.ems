...
export function parseFreezeTimeHHMM(raw: string): { hours: number; minutes: number } | null {
...
export function normalizeFreezeTime(raw: string): string {
...
export function pvBiasConfigFromAdapter(config: unknown): PvBiasConfig {
	const c =
...
export function pvBiasConfigReady(cfg: PvBiasConfig): boolean {
