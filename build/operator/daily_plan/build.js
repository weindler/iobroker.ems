...
function computeTotals(slots, allocations, day) {
    ...
    for (const a of allocations) {
        ...
        if (a.mandatory) {
            mandatoryAlloc += e;
            if (a.requestedEnergyKwh !== null)
                mandatoryReq += a.requestedEnergyKwh;
        }
        else {
            flexAlloc += e;
            if (a.requestedEnergyKwh !== null)
                flexReq += a.requestedEnergyKwh;
        }
    }
    return {
...
Object.defineProperty(exports, "dailyPlanRevisionPayload", { enumerable: true, get: function () { return revision_1.dailyPlanRevisionPayload; } });
