 ...
 */
function validEvTargetSocPct(value: number | null): number | null {
			...
			? (() => {
					...
					return {
						...
						mayUseBatteryForImmersion:
							bool(ihD, "mayUseBatteryForImmersion") === true,
...
function mapWallbox(
	...
	const targetSocPct =
		validEvTargetSocPct(num(wbD, "planSocPct")) ??
