...
export async function ensureEconomicsStates(host: StateHost): Promise<void> {
	...
	const defs: StateDef[] = [
		...
		numState(ECONOMICS_FLAT.todayEmsVorteilEur, "EMS-Vorteil heute", "EUR"),
		...
		numState(ECONOMICS_FLAT.periodEmsVorteilEur, "EMS-Vorteil Zeitraum", "EUR"),
		...
		numState(ECONOMICS_FLAT.cumulativeEmsVorteilEur, "EMS-Vorteil kumuliert", "EUR"),
