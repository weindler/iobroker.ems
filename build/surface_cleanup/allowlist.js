...
exports.LEARNING_MIRROR_PURGE_RE = /^learning\.persistence\.(battery_runtime|house_load|thermal_runtime|thermal_boiler|price_learning|price_forecast|price_outlook|pv_bias_daily|power_hourly|energy_daily)_json$/;
...
const PRICE_LEARNING_BALLAST_RE = /^learning\.price_learning\.(cheap_hours|expensive_hours|missing_days|price_source)$/;
