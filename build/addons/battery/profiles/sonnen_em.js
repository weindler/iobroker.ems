...
exports.SONNEN_EM_PROFILE = {
    ...
    catalog: {
        manufacturerId: "sonnen",
        manufacturerNameDe: "Sonnen",
        templateKind: "manufacturer",
        integration: "state_mapping",
        setupKind: "manual_mapping",
        genericFallback: false,
        manualMappingAvailable: true,
        setupHintDe: "Sonnen-Instanz auswählen beziehungsweise deren Status-, Mode- und Leistungsdatenpunkte zuordnen.",
    },
    plannerCapabilities: {
        chargeDispatch: true,
        activeDischargeDispatch: false,
        passiveSelfConsumption: true,
        gridBalanceControl: true,
    },
    supportsRead: true,
    supportsDryrun: true,
    supportsLive: true,
    ...
    buildCapabilities(input) {
        ...
        const dischargeWrite = (0, mapping_1.isMappingConfigured)(mapping, "set_discharge_power");
        ...
        m.hold_battery = (0, capabilities_1.capability)(true, modeWrite && dischargeWrite && limitsValid, "mapping_or_limits");
        m.set_discharge_power = (0, capabilities_1.capability)(true, dischargeWrite && limitsValid, dischargeWrite ? "limits_invalid" : "mapping_missing");
