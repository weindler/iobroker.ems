...
(0, node_test_1.describe)("planner_authority lazy load", () => {
    (0, node_test_1.it)("authoritative_source parse alone does not load service", () => {
        const modules = run(`
...
`);
    ...
    (0, node_test_1.it)("action_bridge alone does not load service", () => {
        const modules = run(`
const path = require("path");
require(path.join(process.cwd(), "build/planner_authority/action_bridge.js"));
console.log(Object.keys(require.cache).join("\\n"));
`);
        strict_1.default.ok(!modules.some((e) => e.includes("/build/planner_authority/service.js")));
    });
});
