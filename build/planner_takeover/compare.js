...
exports.compareNormalizedPlans = void 0;
const canonize_1 = require("./canonize");
function pushMismatch(out, path, domain) {
 ...
 */
function compareNormalizedPlans(authoritative, candidate) {
    ...
    if (authoritative.horizon.start !== candidate.horizon.start ||
    ...
    for (let i = 0; i < slotCount; i++) {
        ...
        if (!a || !b) {
            ...
            if (!(0, canonize_1.numbersSemanticallyEqual)(a.pvPowerW, b.pvPowerW, "power_w")) {
                pushMismatch(mismatches, `slots[${i}].pvPowerW`, "forecast");
            }
            if (!(0, canonize_1.numbersSemanticallyEqual)(a.houseLoadPowerW, b.houseLoadPowerW, "power_w")) {
                pushMismatch(mismatches, `slots[${i}].houseLoadPowerW`, "forecast");
            }
            if (!(0, canonize_1.numbersSemanticallyEqual)(a.fixedBalancePowerW, b.fixedBalancePowerW, "power_w")) {
                pushMismatch(mismatches, `slots[${i}].fixedBalancePowerW`, "forecast");
            }
            if (!(0, canonize_1.numbersSemanticallyEqual)(a.gridPriceCtPerKwh, b.gridPriceCtPerKwh, "price_ct")) {
            ...
            if (!(0, canonize_1.numbersSemanticallyEqual)(a.gridMaxImportPowerW, b.gridMaxImportPowerW, "power_w")) {
    ...
    for (let i = 0; i < allocCount; i++) {
        ...
        if (!(0, canonize_1.numbersSemanticallyEqual)(a.powerW, b.powerW, "power_w")) {
            pushMismatch(mismatches, `allocations[${i}].powerW`, "allocation");
        }
        if (!(0, canonize_1.numbersSemanticallyEqual)(a.energyKwh, b.energyKwh, "energy_kwh")) {
    ...
    for (const key of totalsKeys) {
        if (!(0, canonize_1.numbersSemanticallyEqual)(authoritative.totals[key], candidate.totals[key], "energy_kwh")) {
...
exports.compareNormalizedPlans = compareNormalizedPlans;
