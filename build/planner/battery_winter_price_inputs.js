...
async function readTibber15MinPriceSlots(host, now) {
    const input = await (0, operator_1.collectGridSupplyBuildInput)(host, now);
    const forecast = (0, operator_1.buildGridSupplyForecast)(input);
    return (0, operator_1.gridSlotsToPrice15Min)(forecast.slots);
}
