...
async function ensureBatteryRuntimeLearningStates(host) {
    ...
    const defs = [
        ...
        numState("learning.battery_runtime.median_night_discharge_kwh", "Battery-Runtime Median Nachtentladung (Diagnose)", "kWh"),
        strState("learning.battery_runtime.night_estimator", "Battery-Runtime verwendeter Nacht-Schätzer", "recency_weighted_average"),
        ...
        strState("learning.battery_runtime.night_samples_json", "Battery-Runtime Nacht-Einzelbefunde (JSON)", "[]"),
        ...
        numState("learning.battery_runtime.grid_balance_attributed_nights", "Battery-Runtime Nächte mit abgezogener Netzausgleichs-Energie"),
        numState("learning.battery_runtime.grid_balance_excluded_nights", "Battery-Runtime Nächte ausgeschlossen (Netzausgleichs-Anteil nicht bestimmbar)"),
