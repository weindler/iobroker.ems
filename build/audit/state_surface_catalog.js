...
exports.summarizeStateSurfaceCatalog = exports.STATE_SURFACE_FAMILIES = void 0;
/** Catalog of known families — counts are code-derived estimates, not live instance scans. */
exports.STATE_SURFACE_FAMILIES = [
    {
        id: "global",
    ...
    },
    {
        ...
        migrationStrategy: "Collapse to ~8 user-facing status fields; hide revision/comparison detail behind diagnostic mode; rename away from shadow/candidate.",
    },
    {
    ...
    },
    {
        ...
        migrationStrategy: "Write to ems-runtime.<n>/planner/forecast/; keep status+generated_at+revision states only.",
        largeJsonIds: [
    ...
    },
    {
        ...
        publicFeature: false,
        targetClass: "D_internal_file_data",
        migrationStrategy: "Durable canonical already under ems.<n>/planner/; stop mirroring full JSON to states; keep compact status.",
        largeJsonIds: [
    ...
    },
    {
        ...
        publicFeature: false,
        targetClass: "B_advanced_user",
        migrationStrategy: "Keep status+key scalars; stop dual-writing large JSON to states when files already exist under durable learning/.",
        largeJsonIds: [
    ...
    },
    {
        ...
        dynamicNote: "Phase 4B1: only configured units (enabled OR mapping target). Unconfigured unit_2..5 placeholders are not ensured and may be cleaned.",
        dataTypes: ["string", "number", "boolean"],
        readWrite: "mixed",
        ...
        publicFeature: true,
        targetClass: "A_core_user",
        migrationStrategy: "Ensure only configured units; controlled cleanup allowlist for never-configured placeholders; keep disabled-but-configured.",
    },
    {
        id: "diagnostics_misc",
...
function summarizeStateSurfaceCatalog() {
    const byClass = {
        A_core_user: 0,
        B_advanced_user: 0,
